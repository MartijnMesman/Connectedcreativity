...
export default function Dashboard() {
  ...
  const upcomingDeadlines = [
    { title: "Mind Wandering Reflectie", date: "15 Dec 2024", type: "assignment" },
    { title: "Collaborative Creativity Sessie", date: "18 Dec 2024", type: "physical" },
    { title: "Intuition Zelfstudie", date: "22 Dec 2024", type: "online" },
  ]

  const recentActivity = [
    { action: "Voltooid", module: "Mind Wandering - Stream of Consciousness", time: "2 uur geleden" },
    { action: "Gestart", module: "Mind Wandering - Context", time: "1 dag geleden" },
    { action: "Voltooid", module: "Introduction - Nieuwsgierigheids-mapping", time: "3 dagen geleden" },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-green-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">Hier is een overzicht van je voortgang in Connected Creativity.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-purple-200">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Voortgang Overzicht</h2>
              
              {/* Progress Bar */}
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-gray-700">Totale Voortgang</span>
                  <span className="text-sm font-medium text-purple-600">2 van 11 modules voltooid</span>
                </div>
            ...
            {/* Recent Activity */}
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-purple-200">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Recente Activiteit</h2>
              <div className="space-y-4">
                {recentActivity.map((activity, index) => (
                  <div key={index} className="flex items-center space-x-4 p-3 bg-white rounded-lg border border-gray-200">
                    <div className={`w-3 h-3 rounded-full ${
                      activity.action === 'Voltooid' ? 'bg-green-500' : 'bg-blue-500'
                    }`}></div>
          ...
          <div className="space-y-6">
            {/* Quick Stats */}
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-purple-200">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Statistieken</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Modules voltooid</span>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-blue-600">8.5 uur</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Streak</span>
                  <span className="font-bold text-orange-600">5 dagen</span>
                </div>
              </div>
            </div>
            ...
            {/* Upcoming Deadlines */}
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-purple-200">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Aankomende Deadlines</h3>
                ...
                {upcomingDeadlines.map((deadline, index) => (
                  <div key={index} className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <span className={`inline-block mt-1 text-xs px-2 py-1 rounded-full ${
                      ...
                      {deadline.type === 'physical' ? 'Fysieke Sessie' : 
                       deadline.type === 'assignment' ? 'Opdracht' : 'Online'}
                    </span>
                  </div>
                ))}
              </div>
